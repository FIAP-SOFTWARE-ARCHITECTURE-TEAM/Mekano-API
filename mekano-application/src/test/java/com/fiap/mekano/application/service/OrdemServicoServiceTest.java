...
class OrdemServicoServiceTest {
    ...
    void deveDiagnosticarOsEAuditar() {
        ...
        OrdemServico os = OrdemServico.restaurar(osUuid, OsStatus.ABERTA);
        ...
        assertEquals(OsStatus.DIAGNOSTICADA, result.getStatus());
    ...
    void deveCancelarOsEAuditar() {
        UUID osUuid = UUID.randomUUID();
        OrdemServico os = OrdemServico.restaurar(osUuid, OsStatus.APROVADA);
