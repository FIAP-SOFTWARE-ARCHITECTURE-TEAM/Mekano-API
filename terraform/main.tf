...
# Evolution API runs inside Kubernetes with Mekano's shared RDS.
# Database "evolution" is created alongside "mekano" on the same PostgreSQL instance.
# No separate RDS instance or Redis cache is provisioned.
