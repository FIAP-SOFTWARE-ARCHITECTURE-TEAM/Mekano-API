...
public class RequisicaoCompraResource {
        ...
        @APIResponse(responseCode = "200", description = "Requisição encontrada", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = RequisicaoCompraResponse.class)))
        @APIResponse(responseCode = "404", description = "Requisição não encontrada", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = ProblemDetail.class)))
        ...
        @APIResponse(responseCode = "200", description = "Lista paginada de requisições", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = RequisicaoCompraPageResponse.class)))
        public Response listAll(
                ...
                var response = new RequisicaoCompraPageResponse(content, normalizedPage, normalizedSize, total,
                                totalPages);
        ...
        @APIResponse(responseCode = "200", description = "Requisição cancelada", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = RequisicaoCompraResponse.class)))
        @APIResponse(responseCode = "404", description = "Requisição não encontrada", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = ProblemDetail.class)))
        @APIResponse(responseCode = "409", description = "Requisição não pode ser cancelada", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = ProblemDetail.class)))
        ...
        @APIResponse(responseCode = "200", description = "Requisição enviada", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = RequisicaoCompraResponse.class)))
        @APIResponse(responseCode = "404", description = "Requisição não encontrada", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = ProblemDetail.class)))
        @APIResponse(responseCode = "409", description = "Requisição não pode ser enviada", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = ProblemDetail.class)))
        ...
        @APIResponse(responseCode = "200", description = "Requisição recebida", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = RequisicaoCompraResponse.class)))
        @APIResponse(responseCode = "404", description = "Requisição não encontrada", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = ProblemDetail.class)))
        @APIResponse(responseCode = "409", description = "Requisição não pode ser recebida", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = ProblemDetail.class)))
