...
@DisplayName("WhatsAppPagamentoObserver")
class WhatsAppPagamentoObserverTest {
    ...
    private final WhatsAppPagamentoObserver observer =
            new WhatsAppPagamentoObserver(notifier, osRepository, clienteRepository, veiculoRepository);
    ...
    @Test
    @DisplayName("deve notificar retirada via WhatsApp quando cliente tem telefone")
    void deveNotificarRetiradaQuandoClienteTemTelefone() {
    ...
    void erroNoLookup_naoDevePropagar() {
        ...
        assertDoesNotThrow(() -> observer.aoConfirmarPagamento(event));
