...
## Goal
Create all new JPA entities extending BaseEntity, domain model classes, value objects, enums, Flyway migrations V6-V11, repository port interfaces, entity mappers, and Panache repository stubs for Phase 2 aggregates. This is the infrastructure foundation for both Estoque and Orcamento subdomains.
...
### Task 6: Flyway Migrations V6-V11

**Files created:**
- `mekano-infrastructure/src/main/resources/db/migration/V6__create_pecas_table.sql`
- `mekano-infrastructure/src/main/resources/db/migration/V7__create_orcamentos_table.sql`
- `mekano-infrastructure/src/main/resources/db/migration/V8__create_orcamento_itens_table.sql`
- `mekano-infrastructure/src/main/resources/db/migration/V9__create_requisicoes_compra_table.sql`
- `mekano-infrastructure/src/main/resources/db/migration/V10__create_nf_entradas_table.sql`
- `mekano-infrastructure/src/main/resources/db/migration/V11__create_os_audit_log_table.sql`
...
## Risk Mitigation
- **Flyway numbering:** Check `db/migration/` for existing V1-V5 before creating V6-V11. If Phase 1 not applied, renumber starting at V1.
